/**
 * SwipeNavigation.tsx
 * SwipeNavigation menu component.
 */
 ...
 */
const SwipeNavigation: React.FC<SwipeNavigationProps> = (props: SwipeNavigationProps) => {
 ...
 *
 */
const mapStateToProps = (state: any, ownProps: SwipeNavigationProps) => {

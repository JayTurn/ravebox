...
import { RateRaveProps } from './RateRave.interface';
 ...
 */
const RateRave: React.FC<RateRaveProps> = (props: RateRaveProps) => {
              ...
              <Grid item>
                ...
                >
                  <ThumbUpAltRoundedIcon className={clsx(
                    classes.icon, {
                      [classes.iconDefault]: !props.color || props.color === 'default',
                      [classes.iconWhite]: props.color && props.color === 'white',
 ...
 */
const mapStateToProps = (state: any, ownProps: RateRaveProps) => {

...
import { SecuritySettingsProps } from './SecuritySettings.interface';
...
/**
 * Renders security settings for authenticated users.
 */
const SecuritySettings: React.FC<SecuritySettingsProps> = (props: SecuritySettingsProps) => {
 ...
 *
 */
function mapStatetoProps(state: any, ownProps: SecuritySettingsProps) {

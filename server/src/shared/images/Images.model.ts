/**
 * Images.model.ts
 * Model for handling the storage of images.
 */
...
export default class Images {
  ...
  /**
   * Creates a presigned request to be used for image uploads.
   *
   ...
   */
  static CreatePresignedImageRequest(
    filename: string,
    fileSize: string,
    fileType: string,
    s3Location: string
    ...
    const params: S3.PresignedPost.Params = {
      Bucket: `ravebox-${process.env.ENVIRONMENT}`,
      Conditions: [
